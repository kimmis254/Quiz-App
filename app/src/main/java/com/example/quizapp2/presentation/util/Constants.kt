package com.example.quizapp2.presentation.util

object Constants {


    val numberAsString = listOf("10") + (1 until 50).map { it.toString() }
    val categories = listOf(
        ...
        "Entertainment: Science & Nature",
        "Entertainment: Science: Computers",
    ...
    val categoriesMap = mapOf(
        ...
        "Entertainment: Science & Nature" to 17,
        "Entertainment: Science: Computers" to 18,
        "Entertainment: Science: Mathematics" to 19,
        "Mythology" to 20,
        "Sports" to 21,
        "Geography" to 22,
        "History" to 23,
